            ...
            @foreach ($estudiantesGrupos as $estudianteGrupo)
                <tr>
                    ...
                    <td>
                        <table>
                            <tr>
                                <td><a href="{{ route('estudiantes_grupos.edit', $estudianteGrupo->id) }}"
                                        class="btn btn-warning">Editar</a></td>
                                <td><a href="{{ route('estudiantes_grupos.show', $estudianteGrupo->id) }}"
                                        class="btn btn-info">Ver</a></td>
                                <td><a href="{{ route('estudiantes_grupos.delete', $estudianteGrupo->id) }}"
